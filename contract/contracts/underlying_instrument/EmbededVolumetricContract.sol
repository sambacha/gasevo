...
import "./EmbededVolumetricOption.sol";
import "./Dex.sol";

contract EmbededVolumetricContract {
  
  using SafeMath for uint;

  EmbededVolumetricContractToken public token;
  ...
  constructor(EmbededVolumetricContractToken _token) public {
    token = _token;  
  }
